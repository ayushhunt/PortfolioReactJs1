...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Aditya Pratap Singh
        ...
        <h3 className="home__subtitle"> Business Development Executive & Portfolio Manager

        
        </h3>
        <p className="home__description">Driving growth and client success through technical expertise and strategic relationship management.</p>
